...
INPUT_SQL_FILE = MODULE_DIR / "SCRAPE_SAVE" / "trust_fund_payment.sql"
OUTPUT_SQL_FILE = MODULE_DIR / "SCRAPE_DATA_2" / "trust_fund_payment_checked.sql"
LOG_FILE = MODULE_DIR / "Logs" / "trust_fund_payment_checker_1.log.txt"
...
def main() -> int:
    ...
    with INPUT_SQL_FILE.open("r", encoding="utf-8") as infile, OUTPUT_SQL_FILE.open(
        ...
        for raw_line in infile:
            ...
            if not line.startswith("INSERT INTO trust_fund_payment"):
