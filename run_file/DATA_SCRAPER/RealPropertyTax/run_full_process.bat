...
set CHECKER1=%BASE_DIR%SCRAPE_CHECKER\SQL_CHECKER_REALPROPERTYTAX.py
set CHECKER2=%BASE_DIR%SCRAPE_CHECKER\SQL_CHECKER_REALPROPERTYTAX_2.py

echo ==========================================
echo REAL PROPERTY TAX DATA SCRAPER FULL PROCESS
echo ==========================================
echo.
...
if errorlevel 1 (
    echo.
    echo Failed at step 2: SQL_CHECKER_REALPROPERTYTAX
    exit /b 1
)
