...
function TaxOnBusiness({ initialMonth, initialYear }) {
    ...
    useEffect(() => {
      const fetchData = async () => {
        try {
          ...
          setTaxData(response.data); // ✅ Update your state with the API response
        } catch (error) {
          console.error(
            "❌ Error fetching tax-on-business data:",
...
TaxOnBusiness.propTypes = {
    initialMonth: PropTypes.string,
    initialYear: PropTypes.string,
};

export default TaxOnBusiness;
