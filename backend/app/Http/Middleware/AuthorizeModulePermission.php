        ...
        $map = [
            ...
            'waterworks' => [
                'patterns' => [
                    ...
                    'api/accounts',
                    'api/account/*',
                    'api/waterworks/payments',
                    'api/waterworks/payments/export',
                    'api/waterworks/taxpayers',
                    'api/waterworks/taxpayer-payments',
                    'api/waterworks/reports/*',
                    'api/waterworks/payment-edit/*',
                    'api/waterworks/tickets',
                    'api/waterworks/tickets/*',
                    'api/check-storage',
                    'api/test-json',
                    'api/test-save',
